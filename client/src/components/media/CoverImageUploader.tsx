    ...
    <>
      <main className="space-y-4">
        <div className="space-y-2">
          {image?.processedUrl ? (
            <div className="relative aspect-[16/9] h-50 overflow-hidden rounded-2xl group">
              <img
                src={image.processedUrl}
                alt="preview"
                className="aspect-[16/9] h-50 object-cover rounded-2xl"
              />
              {/* Remove button */}
              <button
                type="button"
            ...
            <label className="aspect-[16/9] h-50 group rounded-2xl bg-slate-50 hover:bg-slate-100 flex select-none border-2 border-dashed border-slate-400 hover:border-slate-500 cursor-pointer p-1 transition duration-300">
              <input
                ref={fileInputRef}
                type="file"
                accept="image/*"
