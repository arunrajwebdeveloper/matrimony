...
export const interactionsApi = {
  ...
  ignoreUser: (userId: string) =>
    api.post(`${API_ENDPOINTS.IGNORE_PROFILE}/${userId}`),
  ...
  removeDeclinedlistUser: (userId: string) =>
    api.post(`${API_ENDPOINTS.REMOVE_FROM_DECLINEDLIST}/${userId}`),

  removeAcceptedlistUser: (userId: string) =>
    api.post(`${API_ENDPOINTS.REMOVE_FROM_ACCEPTEDLIST}/${userId}`),
};
